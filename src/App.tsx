...
const DOMAIN_COLORS = {
  'Retention & Archiving': 'text-blue-600',               // Home Buying
  'Complaints Tech (Firstpoint)': 'text-purple-700',      // Everyday Banking
  'Risk Tech': 'text-pink-600',                            // Customer Service Channels
  'Customer Data Tech': 'text-yellow-600',                 // Assisted Channels
  'Financial Services, HR & Treasury': 'text-emerald-700',// Consumer Finance & Retail Tech Engg
  'Workflow Engineering': 'text-cyan-700',                 // AMS
  // 'Bankwest': 'text-orange-700',                        // ❌ Commented as per your instruction
};


const ORDER = [
  "Retention & Archiving",               // was Home Buying
  "Complaints Tech (Firstpoint)",        // was Everyday Banking
  "Risk Tech",                            // was Customer Service Channels
  "Customer Data Tech",                  // was Assisted Channels
  "Financial Services, HR & Treasury",   // was Consumer Finance
  "Workflow Engineering",                // was AMS (Retail Run)
  // "Bankwest"                           // ❌ Commented out as requested
];
...
const DEFAULT_DOMAINS = [
  { domainName: 'Retention & Archiving', lead: 'Manik Ghai', teamSize: '5', status: 'Green', keyInitiatives: [], futureInitiatives: [], lowsrisks: [], top3: [0, 1, 2], editing: false },
  { domainName: 'Complaints Tech (Firstpoint)', lead: 'Manik Ghai', teamSize: '17', status: 'Green', keyInitiatives: [], futureInitiatives: [], lowsrisks: [], top3: [0, 1, 2], editing: false },
  { domainName: 'Risk Tech', lead: 'Jakub Firek', teamSize: '17', status: 'Green', keyInitiatives: [], futureInitiatives: [], lowsrisks: [], top3: [0, 1, 2], editing: false },
  { domainName: 'Customer Data Tech', lead: 'Paul Osborne', teamSize: '1', status: 'Green', keyInitiatives: [], futureInitiatives: [], lowsrisks: [], top3: [0, 1, 2], editing: false },
  { domainName: 'Financial Services, HR & Treasury', lead: 'Richard Spalding', teamSize: '8', status: 'Green', keyInitiatives: [], futureInitiatives: [], lowsrisks: [], top3: [0, 1, 2], editing: false },
  { domainName: 'Workflow Engineering', lead: 'Jayadev Unnithan', teamSize: '5', status: 'Green', keyInitiatives: [], futureInitiatives: [], lowsrisks: [], top3: [0, 1, 2], editing: false },
  // { domainName: 'Bankwest', lead: 'Peter Harvey', teamSize: '11', status: 'Green', keyInitiatives: [], futureInitiatives: [], lowsrisks: [], top3: [0, 1, 2], editing: false }, // ❌ Commented out as requested
];
...
const USERS: Record<string, { password: string; role: string; domain?: string }> = {
  ...
  retentionuser: { password: "retention123", role: "domainUser", domain: "Retention & Archiving" },
  complaintsuser: { password: "complaints123", role: "domainUser", domain: "Complaints Tech (Firstpoint)" },
  risktechuser: { password: "risktech123", role: "domainUser", domain: "Risk Tech" },
  customerdatauser: { password: "customerdata123", role: "domainUser", domain: "Customer Data Tech" },
  finshruser: { password: "finshr123", role: "domainUser", domain: "Financial Services, HR & Treasury" },
  workflowuser: { password: "workflow123", role: "domainUser", domain: "Workflow Engineering" },
